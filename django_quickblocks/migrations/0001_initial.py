# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-06-01 09:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_on', models.DateTimeField(blank=True, default=django.utils.timezone.now, editable=False, help_text=b'When this item was originally created')),
                ('modified_on', models.DateTimeField(blank=True, default=django.utils.timezone.now, editable=False, help_text=b'When this item was last modified')),
                ...
                ('created_by', models.ForeignKey(help_text=b'The user which originally created this item', on_delete=django.db.models.deletion.PROTECT, related_name='django_quickblocks_quickblock_creations', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(help_text=b'The user which last modified this item', on_delete=django.db.models.deletion.PROTECT, related_name='django_quickblocks_quickblock_modifications', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(help_text=b'The user which originally created this item', on_delete=django.db.models.deletion.PROTECT, related_name='django_quickblocks_quickblockimage_creations', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(help_text=b'The user which last modified this item', on_delete=django.db.models.deletion.PROTECT, related_name='django_quickblocks_quickblockimage_modifications', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(help_text=b'The user which originally created this item', on_delete=django.db.models.deletion.PROTECT, related_name='django_quickblocks_quickblocktype_creations', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(help_text=b'The user which last modified this item', on_delete=django.db.models.deletion.PROTECT, related_name='django_quickblocks_quickblocktype_modifications', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
            },
